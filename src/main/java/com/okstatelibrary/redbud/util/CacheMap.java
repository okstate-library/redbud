...
public class CacheMap {
	...
	// Circulation Loan Variables

	public static final String process_CirculationLoan_API_Data_Extraction_By_Location = "process_CirculationLoan_API_Data_Extraction_By_Location";

	public static final String process_CirculationLoan_API_Data_Extraction = "process_CirculationLoan_API_Data_Extraction";

	public static final String process_CirculationLoan_API_Data_Extraction_Daily_Process = "process_CirculationLoan_API_Data_Extraction_Daily_Process";
	...
	public static final String process_Execute_Delete_Inactive_Users = "Process_Execute_Delete_Inactive_Users";
	...
	public static final String process_RFID_Reporting_Process = "RFID_Reporting_Process";
